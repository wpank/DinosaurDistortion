...
def main():
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DinosaurDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DinosaurDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DinosaurDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DinosaurDistortion.iss",inplace=1):
